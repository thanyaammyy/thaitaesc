...
namespace Trirand.Web.UI.WebControls
{
	...
	public sealed class EditDialogSettings : IStateManager
	{
		...
		[Category("Appearance"), DefaultValue(""), Description("The text label of the 'Submit' button in search dialog. Defaults to current localization settings, setting it will override localization default."), NotifyParentProperty(true)]
		...
		[Category("Appearance"), DefaultValue(""), Description("The text label of the 'Cancel' button in search dialog. Defaults to current localization settings, setting it will override localization default."), NotifyParentProperty(true)]
		...
		[Category("Appearance"), DefaultValue(""), Description("The text message the will be displayed while server is updated with new edit values. Defaults to current localization settings, setting it will override localization default."), NotifyParentProperty(true)]
		...
		[Category("Appearance"), DefaultValue(false), Description("Determines whether the edit dialog will be closed automatically after editing has been done or it will stay open. Default is false."), NotifyParentProperty(true)]
		public bool CloseAfterEditing
		{
			get
			{
				object obj = this.ViewState["CloseAfterEditing"];
				return obj != null && (bool)obj;
			}
			set
			{
		...
		[Category("Appearance"), DefaultValue(true), Description("Determines if the grid will auto-reload its contents after editing. True by default."), NotifyParentProperty(true)]
