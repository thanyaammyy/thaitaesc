...
namespace Trirand.Web.UI.WebControls
{
	...
	{
		private AxisCategoryCollection _categoryCollection;
		...
		[Category("Default"), DefaultValue(null), Description("Categories"), MergableProperty(false), PersistenceMode(PersistenceMode.InnerProperty)]
		public virtual AxisCategoryCollection Categories
		{
			get
			{
				if (this._categoryCollection == null)
				{
					this._categoryCollection = new AxisCategoryCollection();
				}
