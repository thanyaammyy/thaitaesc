...
namespace thaitae.lib
{
	...
	public partial class Season : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ChampionLeagueSeasonId;
    ...
    partial void OnChampionLeagueSeasonIdChanging(System.Nullable<int> value);
    partial void OnChampionLeagueSeasonIdChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ChampionLeagueSeasonId")]
		public System.Nullable<int> ChampionLeagueSeasonId
		{
			get
			{
				return this._ChampionLeagueSeasonId;
			}
			set
			{
				if ((this._ChampionLeagueSeasonId != value))
				{
					this.OnChampionLeagueSeasonIdChanging(value);
					this.SendPropertyChanging();
					this._ChampionLeagueSeasonId = value;
					this.SendPropertyChanged("ChampionLeagueSeasonId");
					this.OnChampionLeagueSeasonIdChanged();
				}
			}
		}
	...
	public partial class TeamSeason : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _GroupSeasonId;
		
		private System.Nullable<int> _GroupSeasonOrder;
    ...
    partial void OnGroupSeasonIdChanging(System.Nullable<int> value);
    partial void OnGroupSeasonIdChanged();
    partial void OnGroupSeasonOrderChanging(System.Nullable<int> value);
    partial void OnGroupSeasonOrderChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GroupSeasonId")]
		public System.Nullable<int> GroupSeasonId
		{
			get
			{
				return this._GroupSeasonId;
			}
			set
			{
				if ((this._GroupSeasonId != value))
				{
					this.OnGroupSeasonIdChanging(value);
					this.SendPropertyChanging();
					this._GroupSeasonId = value;
					this.SendPropertyChanged("GroupSeasonId");
					this.OnGroupSeasonIdChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GroupSeasonOrder")]
		public System.Nullable<int> GroupSeasonOrder
		{
			get
			{
				return this._GroupSeasonOrder;
			}
			set
			{
				if ((this._GroupSeasonOrder != value))
				{
					this.OnGroupSeasonOrderChanging(value);
					this.SendPropertyChanging();
					this._GroupSeasonOrder = value;
					this.SendPropertyChanged("GroupSeasonOrder");
					this.OnGroupSeasonOrderChanged();
				}
			}
		}
	...
	public partial class TeamMatch : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _TeamGoalPenalty;
    ...
    partial void OnTeamGoalPenaltyChanging(System.Nullable<int> value);
    partial void OnTeamGoalPenaltyChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TeamGoalPenalty")]
		public System.Nullable<int> TeamGoalPenalty
		{
			get
			{
				return this._TeamGoalPenalty;
			}
			set
			{
				if ((this._TeamGoalPenalty != value))
				{
					this.OnTeamGoalPenaltyChanging(value);
					this.SendPropertyChanging();
					this._TeamGoalPenalty = value;
					this.SendPropertyChanged("TeamGoalPenalty");
					this.OnTeamGoalPenaltyChanged();
				}
			}
		}
